...
// The Fs is a union filesystem: a read only base file system with
...
func New(base afero.Fs, layer afero.Fs) *Fs {
...
func (u *Fs) LstatIfPossible(name string) (os.FileInfo, bool, error) {
...
func (u *Fs) isNotExist(err error) bool {
